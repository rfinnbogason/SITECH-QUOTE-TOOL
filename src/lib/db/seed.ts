...
import {
  settings, salesReps, vendors, freightOptions, labourOptions,
  markupDefaults, installTimes,
} from "./schema"
...
export async function seed() {
  ...
  await db.insert(vendors).values([
    { name: "Trimble", discountPct: 25, paymentTerms: "Net 30", status: "Active" },
    { name: "Topcon", discountPct: 22, paymentTerms: "Net 30", status: "Active" },
    { name: "Leica", discountPct: 20, paymentTerms: "Net 45", status: "Active" },
    { name: "CAT", discountPct: 18, paymentTerms: "Net 30", status: "Active" },
    { name: "John Deere", discountPct: 20, paymentTerms: "Net 30", status: "Active" },
    { name: "Komatsu", discountPct: 15, paymentTerms: "Net 45", status: "Active" },
    { name: "Hitachi", discountPct: 17, paymentTerms: "Net 30", status: "Active" },
    { name: "SITECH Parts", discountPct: 30, paymentTerms: "Net 15", status: "Active" },
    { name: "Third Party", discountPct: 10, paymentTerms: "Net 30", status: "Active" },
    { name: "Custom", discountPct: 0, paymentTerms: "Varies", status: "Active" },
  ]).onConflictDoNothing()

  await db.insert(freightOptions).values([
    { code: "FRT-SMALL", name: "Small Parts", costCad: 75, status: "Active" },
    { code: "FRT-MEDIUM", name: "Medium Parts", costCad: 150, status: "Active" },
    { code: "FRT-LARGE", name: "Large Parts", costCad: 250, status: "Active" },
  ]).onConflictDoNothing()

  await db.insert(labourOptions).values([
    { code: "LAB-INST", name: "Standard Installation", hourlyRateCad: 175, minHours: 2, status: "Active" },
    { code: "LAB-INSTADV", name: "Advanced Installation", hourlyRateCad: 245, minHours: 4, status: "Active" },
    { code: "LAB-CALIB", name: "Calibration & Setup", hourlyRateCad: 210, minHours: 1, status: "Active" },
    { code: "LAB-TRAIN", name: "On-Site Training", hourlyRateCad: 280, minHours: 4, status: "Active" },
    { code: "LAB-TRAINADV", name: "Advanced Training", hourlyRateCad: 260, minHours: 8, status: "Active" },
    { code: "LAB-SUPPORT", name: "Technical Support", hourlyRateCad: 210, minHours: 2, status: "Active" },
    { code: "LAB-REPAIR", name: "Field Repair Service", hourlyRateCad: 245, minHours: 1, status: "Active" },
    { code: "LAB-SURVEY", name: "Survey & Site Assessment", hourlyRateCad: 280, minHours: 4, status: "Active" },
    { code: "LAB-CONSULT", name: "Consulting Services", hourlyRateCad: 315, minHours: 2, status: "Active" },
    { code: "LAB-CUSTOM", name: "Custom Service", hourlyRateCad: 0, minHours: 0, status: "Active" },
  ]).onConflictDoNothing()
